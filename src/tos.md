...
- **Service Availability**: We strive for 99.9% uptime but do not guarantee uninterrupted service. Downtime may occur due to maintenance, upgrades, or unforeseen events. Unless expressly agreed otherwise in writing, no service credits or compensation are payable for downtime.
...
- Engage in spamming, phishing, or other abusive activities, including operating open mail relays or sending unsolicited bulk email.
- Overload or disrupt our servers, networks, or other customers’ services (e.g., DDoS attacks).
- Operate botnets, command-and-control infrastructure, or launch attacks, port scans, or unauthorized penetration tests against third parties.
- Engage in cryptocurrency mining or other sustained workloads that abuse shared resources beyond the fair use of your plan.
- Engage in activity that damages the reputation of our IP address space (e.g., causing IPs to be blacklisted).
- Violate intellectual property rights or privacy laws.

**Tor**: Running Tor relays (non-exit) is permitted. Running Tor exit nodes is not permitted without our prior written consent.

We reserve the right to suspend or terminate your Services without notice if we detect violations, subject to applicable law. Abuse reports may be sent to noc+abuse@apexstrata.ie.

---

## 7. Payment and Billing

- **Fees**: You agree to pay the fees for your chosen plan as outlined at checkout. Prices may be displayed and paid in Euro (€), US Dollar ($), or Bitcoin (BTC, via the Lightning Network or on-chain), as offered at checkout.
- **Exchange Rates**: Where you pay in Bitcoin for a plan priced in fiat currency (or vice versa), the amount payable is calculated at the exchange rate applied at the time the invoice is generated. Once an invoice is paid, it is final; we do not adjust for subsequent exchange rate movements.
- **Billing Cycle**: The Services are prepaid. Payment is due in advance for each billing period of your chosen plan, and your service runs until the end of the period you have paid for.
- **Non-Payment**: If your service is not renewed by its expiry date, it will be stopped and you will no longer be able to access it. It may subsequently be deleted in accordance with Section 8.
- **Refunds**: Refunds are available within 14 days of initial purchase, provided no excessive usage has occurred, as determined by us. Refunds of amounts paid in Bitcoin are made in Bitcoin at the originally invoiced amount.

This section is without prejudice to your statutory rights as a consumer (see Section 7.2).
...
### 7.2 EU Consumer Right of Withdrawal

If you are a consumer in the European Union, you have a statutory right to withdraw from a contract for services within 14 days without giving any reason. By ordering the Services, you request that we begin providing them immediately (your VPS is provisioned upon payment). You acknowledge that:
...
- **Effect of Termination**: Upon termination or expiry of your service, your VPS is stopped and your access to it ends. We may permanently delete your VPS and associated data after 7 days unless otherwise required by law. You are responsible for retrieving your data before your service expires or is terminated; renewing an expired service within the retention period restores access.
...
You agree to indemnify and hold harmless Apex Strata Ltd, its officers, and employees from any claims, damages, losses, or expenses (including reasonable legal fees) arising from your use of the Services, your content, or your violation of these Terms or applicable law. This section does not apply to the extent prohibited by applicable consumer protection law.
...
- For business customers, any disputes will be subject to the exclusive jurisdiction of the courts of Ireland.
- If you are a consumer, this does not affect any mandatory consumer protections or jurisdiction rights you have under the law of your country of residence, and you may bring proceedings in the courts of that country where permitted by law.
...
- **Entire Agreement**: These Terms, together with your chosen service plan, constitute the entire agreement between you and us regarding the Services.
- **Assignment**: You may not assign your rights under these Terms without our prior written consent. We may assign our rights and obligations to a successor of the business.
...
We may update these Terms from time to time. We will notify you of significant changes via email where we hold an email address for you, or otherwise via our website or your account dashboard. Continued use of the Services after changes constitutes acceptance of the updated Terms.
